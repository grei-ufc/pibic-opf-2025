...
\begin{alineascomponto}
    \item \textit{PWF.jl}: leitura e parsing de arquivos no formato ANAREDE PWF, com extração de estruturas de controle habilitada via \texttt{add\_control\_data = true};
...
\IBGEtab{}{
    \begin{tabular}{cllll}
        ...
        F1 & \texttt{(F1)PF\_PM.jl.jl} & PowerModels & FP AC & baseline FP \\
