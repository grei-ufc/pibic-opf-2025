...
A título de ilustração, reproduz-se a seguir o núcleo do \textit{script} \verb|(F2)QLIM+VLIM.jl|, responsável pela construção do modelo JuMP descrito na \autoref{subsec:f16}. O código completo, junto com as demais formulações da progressão F0 a F5, está disponível no repositório do trabalho.
