\apendice{Trecho da implementação JuMP da formulação (16)}
\label{ap:A}

A título de ilustração, reproduz-se a seguir o núcleo do \textit{script} \verb|(16)QLIM+VLIM.jl|, responsável pela construção do modelo JuMP descrito na \autoref{subsec:f16}. O código completo, junto com as demais formulações da progressão (14)--(19), está disponível no repositório do trabalho em \verb|powerflow/Codes/PF_Formulation/|.
