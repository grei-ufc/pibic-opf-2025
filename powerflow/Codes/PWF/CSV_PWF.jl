# Esse codigo eu tento remover ilhas isoladas e componentes desconectados para tentar rodar a simulação e limito o numeor de iterações e cria arquivos CSV
...
result = run_dc_pf(network_data, optimizer)
